...
$pageSubtitle = 'Create a new doctor profile';
require __DIR__ . '/../layouts/app_start.php';
?>

<form method="POST" action="/dental-management-system/public/doctors/store" class="max-w-3xl" enctype="multipart/form-data">
