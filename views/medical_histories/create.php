<?php
$pageTitle = 'Add Medical History';
$pageSubtitle = 'Create a new medical record';
require __DIR__ . '/../layouts/app_start.php';
?>

<form method="POST" action="/dental-management-system/public/medical-histories/store" class="max-w-3xl">
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6 grid grid-cols-1 gap-5">
        <div class="relative">
            ...
            <input type="hidden" name="patient_id" id="mh_patient_id" required>
            <input type="text" id="mh_patient_search" placeholder="Type patient name..."
